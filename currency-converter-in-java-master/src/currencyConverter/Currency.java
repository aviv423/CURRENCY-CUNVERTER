...
public class Currency {
	...
	public void defaultValues() {
		...
		switch (currency) {	
			case "US Dollar":
				this.exchangeValues.put("ILS", 0.31);
				...
				break;
			case "Euro":
				this.exchangeValues.put("ILS", 0.25);
				...
				break;
			case "British Pound":
				this.exchangeValues.put("ILS", 0.22);
				...
				break;
			case "Swiss Franc":
				this.exchangeValues.put("ILS", 0.27);
			...
			case "Chinese Yuan Renminbi":
				...
				break;
			case "Japanese Yen":
				this.exchangeValues.put("ILS", 0.03);
			...
			case "Isreali Shekel":
				...
				this.exchangeValues.put("EUR", 3.97);
				this.exchangeValues.put("GPB", 4.59);
				this.exchangeValues.put("CHF", 3.65);
				this.exchangeValues.put("CNY", 1.97);
				this.exchangeValues.put("JPY", 32.21);
		}
	}
	...
	public static ArrayList<Currency> init() {
		...
		currencies.add( new Currency("Isreali Shekel", "ILS") );
